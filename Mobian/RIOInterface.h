...
@interface RIOInterface : NSObject {
	...
	mbnViewController *__unsafe_unretained listener;
...
@property(nonatomic, unsafe_unretained) id<AVAudioPlayerDelegate> audioPlayerDelegate;
@property(nonatomic, unsafe_unretained) id<AVAudioSessionDelegate> audioSessionDelegate;
@property(nonatomic, unsafe_unretained) mbnViewController *listener;
